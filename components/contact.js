        ...
        <div className={cardStyles.outer}>
          <div className={cardStyles.foil}>
              <div style={{textAlign: 'center'}}>
                ...
                <div className={cardStyles.contactList}>
                    <h1>{userData.name}</h1>
                    <h1>Email</h1>
                    <h2>{userData.email}</h2>
                    <h1>Phone</h1>
                    <h2>{userData.phone}</h2>
                    <Link href="/files/Kim.Daniel.Webdeveloper.2023.pdf"><a className={cardStyles.resume} target="_blank"><h1 fill="currentColor" style={{marginBottom: 0}}>Resume</h1></a></Link>
                    <br></br>
                    <div>
